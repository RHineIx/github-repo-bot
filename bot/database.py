...
class RepositoryTracker:  
    ...
    async def add_tracked_repo(self, user_id: int, owner: str, repo: str, track_types: List[str]) -> bool:  
    ...
    async def update_last_starred_repos(self, github_username: str, starred_repo_ids: set):  
